...
<div class="mx-auto mt-5">
	<?php
	//J'effectue un tri en fonction de l' ID de la personne qui se connecte
	$fk_user = $info['user_id'];

	$conn = $bdd->query("SELECT * FROM rdv WHERE fk_user='$fk_user' ORDER BY rdv_id DESC");
	$conn->execute(array());
