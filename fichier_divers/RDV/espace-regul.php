...
<?php
$conn = $bdd->query("SELECT * FROM rdv INNER JOIN utilisateur ON rdv.fk_user=utilisateur.user_id WHERE statut=0 ");
$conn->execute(array());
        ...
        <div class="col">
            <div class="card bg-white mt-5">
                <div class="card-body">
                    ...
                    <div class="col">
                        <span class="text-dark">Raison transport :</span>
                    ...
                    <div class="col">
                        <span class="text-dark">150 kms :</span>
                        <input type="text" name="" value="<?php
                    ...
                    <div class="col">
                        <span class="text-dark">Soumis à ALD :</span>
                        <input type="text" name="" value="<?php
                                                            if ($row['ald'] == 0) {
                                                                echo ('Oui');
                                                            } elseif ($row['ald'] == 1) {
                    ...
                    <div class="bg-info">
                        ...
                        <div class="col">
                            <span class="text-white">Lieu :</span>
                        ...
                        <div class="col">
                            <span class="text-white">Code postal :</span>
                            <input type="number" name="" value="<?= $row['pick_zip']; ?>" disabled>
                        </div>
                        <div class="col">
                            <span class="text-white">Ville :</span>
                ...
                <div class="col">
                    <form action="espace-regul-traitement.php" method="post">
                        <input type="hidden" name="rdv_id" value="<?= $row['rdv_id']; ?>">
                        <input type="hidden" name="statut" value="1">
                        <button class="btn btn-warning" type="submit" name="valider">Client rappelé</button>
                    </form>
                </div>
            </div>
        </div>
